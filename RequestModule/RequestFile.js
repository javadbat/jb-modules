class RequestFile {
    ...
    constructor({url, file, onSuccess, onProgress, onError, authentication=true}) {
    ...
    uploadFile() {
        ...
        if(this.authentication){
            var authObj = RequestFile.defaults.AuthManagerBridge.getAuthHeaderProperty();
